...
/// Created By Azkadev
///
class PixideoNativeLibraryByAzkadev {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  PixideoNativeLibraryByAzkadev(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  PixideoNativeLibraryByAzkadev.fromLookup(
  ...
  void InitializedPixideoByAzkadevNativeCallbackFunction(
    ffi.Pointer<ffi.Void> callback,
  ) {
    return _InitializedPixideoByAzkadevNativeCallbackFunction(
      callback,
    );
  }

  late final _InitializedPixideoByAzkadevNativeCallbackFunctionPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
          'InitializedPixideoByAzkadevNativeCallbackFunction');
  late final _InitializedPixideoByAzkadevNativeCallbackFunction =
      _InitializedPixideoByAzkadevNativeCallbackFunctionPtr.asFunction<
          void Function(ffi.Pointer<ffi.Void>)>();

  ffi.Pointer<ffi.Char> InvokePixideoByAzkadevNativeFunction(
    ffi.Pointer<ffi.Char> parameters,
  ) {
    return _InvokePixideoByAzkadevNativeFunction(
      parameters,
    );
  }

  late final _InvokePixideoByAzkadevNativeFunctionPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<ffi.Char> Function(
              ffi.Pointer<ffi.Char>)>>('InvokePixideoByAzkadevNativeFunction');
  late final _InvokePixideoByAzkadevNativeFunction =
      _InvokePixideoByAzkadevNativeFunctionPtr.asFunction<
          ffi.Pointer<ffi.Char> Function(ffi.Pointer<ffi.Char>)>();
}
